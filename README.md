# OINO TS
 ...
 ### HTMX utils
 OINO is well suited to be used as almost complete backend for HTMX and this can be further helped with efficient utilities to map `OINOModelSet` to HTMX template.
