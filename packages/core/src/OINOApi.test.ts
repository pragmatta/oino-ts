...
const apis:OINOTestApiParams[] = [
    {
        ...
        requestParams: {
            sqlParams: { filter: new OINOSqlFilter("(ShipPostalCode)-like(0502%)"), order: new OINOSqlOrder("ShipPostalCode desc") }
        },
    ...
    },
    {
        ...
        requestParams: {
            sqlParams: { filter: new OINOSqlFilter("(UnitsInStock)-le(5)"), order: new OINOSqlOrder("UnitsInStock asc,UnitPrice asc") }
        },
    ...
    },
    {
        ...
        requestParams: {
            sqlParams: { filter: new OINOSqlFilter("(TitleOfCourtesy)-eq(Ms.)"), order: new OINOSqlOrder("LastName") }
        },
    ...
    },
    {
        ...
        requestParams: {
            sqlParams: { filter: new OINOSqlFilter("(Quantity)-gt(100)"), order: new OINOSqlOrder("Quantity desc") }
        },
