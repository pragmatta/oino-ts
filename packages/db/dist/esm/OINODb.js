    ...
    async doTableSchemaRequest(method, tableName, body) {
        ...
        try {
            ...
            if (method == "GET") {
                ...
                const fields = schemas.map((s) => OINODataField.fromSchema(this, s, this.getNativeDataType(s)));
    ...
    async doColumnSchemaRequest(method, tableName, columnName, body) {
        ...
        try {
            ...
            if (method == "GET") {
                ...
                const field = OINODataField.fromSchema(this, schema, this.getNativeDataType(schema));
