...
class OINODbDataModel extends common_1.OINODataModel {
    ...
    _buildSelect(id, params, parameterized) {
        const statement = new OINODbSqlStatement_js_1.OINODbSqlStatement(this.dbApi.db, parameterized);
        let column_names = "";
        if (params.aggregate) {
        ...
        let order_sql = params.order ? OINODbQueryParams_js_1.OINODbQueryOrder.printSql(params.order, this) : "";
        ...
        const filter_sql = params.filter ? OINODbQueryParams_js_1.OINODbQueryFilter.buildSql(params.filter, this, statement) : "";
        let where_sql = "";
