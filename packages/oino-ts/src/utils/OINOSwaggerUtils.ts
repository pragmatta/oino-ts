...
import { OINOApi, OINODataField, OINOLog } from "../OINOTypes";
...
export class OINOSwagger {
    ...
    private static _getSwaggerApiType(api:OINOApi):any {
        ...
        OINOLog.debug("getApiTypeSchema", {result:result, type:typeof(result)})
        return result
    }
    ...
    static getApiDefinition(apis:OINOApi[]): any {
        ...
        //logDebug("getApiElysiaHttpGetType", {result:result, type:typeof(result)})
        return result
    }
}