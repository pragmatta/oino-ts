 ...
 */
import { OINODb, OINODataSet, OINONumberDataField, OINOStringDataField, OINO_ERROR_PREFIX, OINOLog, OINOBenchmark, OINODatetimeDataField, OINOBlobDataField } from "@oino-ts/core";
import { Pool } from "pg";
const EMPTY_ROW = [];
